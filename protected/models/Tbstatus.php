...
class Tbstatus extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, s_name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tbMilestones' => array(self::HAS_MANY, 'TbMilestone', 'm_status'),
			'tbProjects' => array(self::HAS_MANY, 'TbProject', 'pr_status'),
			'tbTasks' => array(self::HAS_MANY, 'TbTask', 't_status'),
		);
	}
